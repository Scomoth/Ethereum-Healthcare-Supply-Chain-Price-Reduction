...
contract healthcareprovider_receiveslog{
    ...
    event distributor_to_healthcareprovider_transaction(
    ...
    function ReceivesLog(
        ...
        emit distributor_to_healthcareprovider_transaction(sender, receiver, batch_id, medicine_name, medicine_type, 
    ...
    function transaction() public {
        ...
        emit Transaction_Request(sender, payment_address, batch_id, total_price);
